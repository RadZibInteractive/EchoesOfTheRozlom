...
#include "Weapons/EotRProjectile.h"
...
AEotRProjectile::AEotRProjectile()
{
...
void AEotRProjectile::BeginPlay()
{
	Super::BeginPlay();
...
void AEotRProjectile::NotifyHit(class UPrimitiveComponent* MyComp, AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AEotRProjectile::DamageCharacter(ACharacter* HitCharacter, const FHitResult& Hit)
{
