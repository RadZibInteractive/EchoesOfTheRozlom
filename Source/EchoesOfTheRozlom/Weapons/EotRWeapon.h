...
#include "EotRWeapon.generated.h"

class IEotRWeaponHolder;
class AEotRProjectile;
class USkeletalMeshComponent;
class UAnimMontage;
class UAnimInstance;

/**
 *  Base class for a simple first person EotR weapon
 *  Provides both first person and third person perspective meshes
 *  Handles ammo and firing logic
 *  Interacts with the weapon owner through the EotRWeaponHolder interface
 */
UCLASS(abstract)
class ECHOESOFTHEROZLOM_API AEotRWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	IEotRWeaponHolder* WeaponOwner;

	/** Type of projectiles this weapon will shoot */
	UPROPERTY(EditAnywhere, Category="Ammo")
	TSubclassOf<AEotRProjectile> ProjectileClass;
