...
#include "EotRGameplayCueManager.generated.h"
...
/**
 * UEotRGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UEotRGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UEotRGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UEotRGameplayCueManager* Get();
