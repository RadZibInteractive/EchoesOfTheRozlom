...
#include "EotRAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FEotRAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UEotRAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FEotRAbilityTagRelationship> AbilityTagRelationships;
