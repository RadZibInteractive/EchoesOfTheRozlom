...
#include "EotRStateTreeUtility.generated.h"

class AEotRNPC;
class AAIController;
class AEotRAIController;
 ...
 */
USTRUCT(DisplayName = "Has Line of Sight to Target", Category="EotR")
 ...
 */
USTRUCT(meta=(DisplayName="Face Towards Actor", Category="EotR"))
 ...
 */
USTRUCT(meta=(DisplayName="Face Towards Location", Category="EotR"))
 ...
 */
USTRUCT(meta=(DisplayName="Set Random Float", Category="EotR"))
 ...
 */
USTRUCT(meta=(DisplayName="Shoot at Target", Category="EotR"))
...
struct FStateTreeSenseEnemiesInstanceData
{
	...
	UPROPERTY(EditAnywhere, Category = Context)
	TObjectPtr<AEotRAIController> Controller;
 ...
 */
USTRUCT(meta=(DisplayName="Sense Enemies", Category="EotR"))
