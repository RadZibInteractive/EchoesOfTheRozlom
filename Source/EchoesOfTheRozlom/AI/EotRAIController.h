...
DECLARE_DELEGATE_TwoParams(FEotRPerceptionUpdatedDelegate, AActor*, const FAIStimulus&);
DECLARE_DELEGATE_OneParam(FEotRPerceptionForgottenDelegate, AActor*);

/**
 *  Simple AI Controller for a first person EotR enemy
 */
UCLASS(abstract)
...
public:
	...
	FEotRPerceptionUpdatedDelegate OnEotRPerceptionUpdated;

	/** Called when an AI perception has been forgotten. StateTree task delegate hook */
	FEotRPerceptionForgottenDelegate OnEotRPerceptionForgotten;
